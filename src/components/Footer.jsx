...
const Footer = () => {
    return (
        <footer className="shadow-2xl bg-gray-400">
            <div className="container gap-4 flex flex-col md:flex-row justify-center items-center p-4 mx-auto md:p-8 lg:flex-row dark:divide-gray-600">
                <Link to="/" className="text-5xl font-bold text-orange-500 flex-1">RUN</Link>
                <Link to="/description" className="text-red-600 text-xl underline">Description</Link>
